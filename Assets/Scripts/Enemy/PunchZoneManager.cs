...
public class PunchZoneManager
{
    ...
    public PunchData GetPunchData(PunchZone punchedZone, SaveLoadData saveLoadData)
    {
        ...
        PunchData punchData = new PunchData(damage, punchType);
